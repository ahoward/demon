class Demon
  ...
  def run(which = :run, &block)
    ...
    loop do
        ...
        begin
          ...
          Demon.logger.error(e)

        ensure
          wait(420) # NOTE: signals wake this up!
        end
      end
    end
  end
  ...
  def redeployed?
    return false unless @restart_txt
